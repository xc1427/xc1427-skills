...
3. End the window at the start of the user's next message, before handling that message. Do not carry these overrides forward unless the user explicitly invokes `cx1-afk` again.
