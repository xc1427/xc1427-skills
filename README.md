...
| Skill | Description |
|-------|-------------|
| [cx1-yuque](skills/cx1-yuque/SKILL.md) | Unified standalone Yuque CLI: direct Open/Web API workflows, explicit sessions, and project-local latest official CLI fallback |
